...
function TermsContent() {
  return (
    <div>
      ...
      <Section title="3. Cadastro e Responsabilidades do Usuário">Você é responsável pela veracidade e atualização das informações fornecidas no cadastro (nome, e-mail, telefone, sexo). Seu login e senha são pessoais e intransferíveis. O compartilhamento de credenciais é proibido, e o Nosso Momento não se responsabiliza por acessos indevidos decorrentes de negligência do usuário. Você se compromete a não utilizar o aplicativo para fins ilícitos, discriminatórios ou que violem direitos de terceiros.</Section>
...
function PrivacyContent() {
  return (
    <div>
      ...
      <Section title="2. Dados Coletados e Finalidade">Coletamos apenas os dados estritamente necessários: nome, sexo, e-mail, telefone, foto de perfil (opcional), token FCM, dados de uso (check-ins, desafios, conquistas, memórias) e dados de dispositivo para segurança.</Section>
